      ...
      <div className="pt-24 md:pt-32 w-full">
        ...
        <section className="text-center py-16 px-4">
          ...
          <button
            ...
            className="bg-[#FF6F61] text-white px-6 py-2 rounded-md hover:bg-[#e65a4f] transition duration-300"
          >
            Get Started
          </button>
        </section>
        ...
        <section className="bg-white w-full py-12 px-4 mt-8 rounded-lg">
          <h2 className="text-3xl font-semibold text-center mb-8">
            Our Features
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {/* Feature 1 */}
            <div className="p-6 bg-[#FADADD] rounded-md text-center">
