  ...
  return (
    <div className="bg-[#FADADD] min-h-screen flex flex-col items-center text-[#333333]">
      ...
      <div className="pt-24 md:pt-32 w-full">
        ...
        <section className="bg-white w-full py-12 px-4 shadow-md rounded-lg mt-8">
          <h2 className="text-3xl font-semibold text-center mb-8">
            Our Features
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {/* Feature 1 */}
            <div className="p-6 bg-[#FADADD] rounded-md shadow-md text-center hover:shadow-lg transition duration-300">
